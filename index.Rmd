...
ggplot(excess_data_long %>% 
         mutate(weekstart_covidyears = ISOweek::ISOweek2date(paste0(roktyden_iso, 
                                                                     "-", 1)),
                alpha = if_else(weekstart_covidyears >= (date_last_stats + days(2)), 
                                "nedostupná", "dostupná")) %>% 
...
ggplot(excess_data_long2 %>% 
         mutate(weekstart_covidyears = ISOweek::ISOweek2date(paste0(roktyden_iso, 
                                                                     "-", 1)),
                alpha = if_else(weekstart_covidyears > date_last_stats + 2, 
                                "nedostupná", "dostupná")), 
...
ggplot(excess_data_long %>% 
         mutate(weekstart_covidyears = ISOweek::ISOweek2date(paste0(roktyden_iso, 
                                                                     "-", 1)),
                alpha = if_else(weekstart_covidyears > (date_last_stats + 2), "nedostupná", "dostupná")),
       aes(weekstart_covidyears)) +
  geom_col(aes(y = value, fill = name, alpha = alpha)) +
