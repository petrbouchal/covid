...
ggplot(excess_data_long2 %>% 
         mutate(weekstart_2020 = as.Date(paste(2020, tyden, 1, sep="-"), 
                                         "%Y-%U-%u") - days(6),
                alpha = if_else(weekstart_2020 > date_last_stats, 
                                "nedostupná", "dostupná")), 
       aes(weekstart_2020)) +
  geom_col(aes(y = value, fill = name, alpha = alpha)) +
  ...
  scale_fill_manual(values = c(stat_dead_normd_covidyears = "grey",
                               umrti_covid = "blue"),
