...
excess_data %>% 
  ...
  geom_line(aes(y = umrti_mean_lastyrs, colour = "průměr 2016-19"), size = .5) +
  geom_line(aes(y = umrti_abs2020, colour = "2020"), size = .5) +
  scale_colour_manual(values = c(`průměr 2016-19` = "grey",
                                 `2020` = "blue",
                                 `Nárůst navíc` = "pink", 
                                 `Covid-19` = "lightblue"),
